            ...
            <div class="container-fluid">
                <div class="row">
                    <?php while ($row = $result_customer->fetch_assoc()){ ?>
                        <div class="col-md-4">
                            <div class="card card-customer" onclick="window.location.href='queue.php?booking_id=<?php echo $row['id'] ?>'">
                                <div class="content">
                                    <ul class="list-unstyled team-members" style="    margin-bottom: 0px;">
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-5" style="text-align: center;border-right: 1px solid #ddd;">
                                                    <div class="col-xs-12" style="padding-left: 31px;padding-bottom: 10px;">
                                                        <div class="avatar">
                                                ...
                                                <div class="col-xs-7 text-center">
                                                    ...
                                                    <h6><p class="category"><?php  echo date('H:i', strtotime($row['time_end'])); ?> - <?php  echo date('H:i', strtotime($row['time_end'])); ?> </p></h6>
